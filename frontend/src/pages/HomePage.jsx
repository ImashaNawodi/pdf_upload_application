  ...
  return (
    <div>
      ...
      >
        ...
        {user && (
        <button    onClick={handleClick} className="absolute bg-red-600 hover:bg-red-700 text-white p-3 top-0 right-0 mt-3 mr-5">
      Log out
        </button>
          )}
              {!user && (
        <button className="absolute bg-red-600 hover:bg-red-700 text-white p-3 top-0 right-0 mt-3 mr-5">
          ...
          <div className="space-y-5">
            ...
            <p className="text-white font-semibold text-3xl flex flex-col items-center">
              Join us and manage your documents anywhere.
            </p>
